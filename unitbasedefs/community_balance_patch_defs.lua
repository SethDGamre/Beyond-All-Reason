local function communityBalanceTweaks(name, uDef, modOptions)
	...
	if modOptions.community_balance_corspy then
		if name == "corspy" then
	...
	if modOptions.community_balance_armmav then
		if name == "armmav" then
			uDef.metalcost = 520
	...
	if modOptions.community_balance_corcan then
		if name == "corcan" then
	...
	if modOptions.community_balance_corkarg then
	...
	if modOptions.community_balance_armkam then
		if name == "armkam" then
			uDef.maxacc = 0.35
	...
	if modOptions.community_balance_armblade then
